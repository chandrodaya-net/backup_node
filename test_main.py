...
class TestMainJuno(unittest.TestCase):
    ...
    def test_CMD_MAP(self):
        expected_CMD_MAP = {'start_node': 'sudo systemctl start junod', 
                            ...
                            'set_home_binary_systemd_file_NEW': 'sed -i "s/\\"DAEMON_HOME=*.*/\\"DAEMON_HOME=\\/mnt\\/volume_fra1_02\\/workspace\\/.juno\\"/" /etc/systemd/system/junod.service; sudo systemctl daemon-reload', 
                            'set_home_binary_profile_file_NEW': 'sed -i "s/DAEMON_HOME=*.*/DAEMON_HOME=\\/mnt\\/volume_fra1_02\\/workspace\\/.juno/" ~/.profile ; . ~/.profile', 
                            'set_home_binary_NEW': 'set_home_binary_systemd_file_NEW; set_home_binary_profile_file_NEW', 
                            'set_home_binary_systemd_file_CUR': 'sed -i "s/\\"DAEMON_HOME=*.*/\\"DAEMON_HOME=\\/mnt\\/volume_fra1_01\\/workspace\\/.juno\\"/" /etc/systemd/system/junod.service; sudo systemctl daemon-reload', 
                            'set_home_binary_profile_file_CUR': 'sed -i "s/DAEMON_HOME=*.*/DAEMON_HOME=\\/mnt\\/volume_fra1_01\\/workspace\\/.juno/" ~/.profile ; . ~/.profile', 
